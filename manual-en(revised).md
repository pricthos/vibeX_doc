...
* **Replacing an Image:** There are three ways to replace an image.
	1. **Upload the image you want to use**, then **ask the AI to replace the existing image with the uploaded one.**
	2. **Ask the AI to generate a new image**, then **replace the existing image with the generated one.**
	3. **Copy the image URL**, paste it directly into the file you want to modify in the **Code** menu, and click **“Save.”**
